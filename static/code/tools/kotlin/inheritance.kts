...
// all classes have a common superclass Any which is the default superclass for a class with no supertypes declared

// the Any has three methods: equals(), hashCode() and toString()

// by default classes are final and so cannot be inherited

// a class must be marked with the open keyword to make it inheritable
open class Base(p: Int)

// to inherit from a supertype we place the type after a colon in the class header
