...
class Simulator {
  ...
  constructor(canvasId, rows, cols, pixelSize, interRoundDelay, initialChanceOfLife) {
    this.rows = rows;
    this.cols = cols;
...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  let sim = new Simulator('gol', rows, cols, pixelSize, roundDelay, chanceOfLife);
